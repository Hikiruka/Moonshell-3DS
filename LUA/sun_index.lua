...
record = Graphics.loadImage(theme_dir.."/images/record"..ext)
...
table.insert(tools,{calc,"/modules/calc.lua","Calculator"})
table.insert(tools,{record,"/modules/record.lua","Record"})
